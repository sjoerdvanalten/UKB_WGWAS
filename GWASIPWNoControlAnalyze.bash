...
../SOFTWARE/ldsc/./munge_sumstats.py --sumstats ../OUTPUT/GWAS/LassoWeight.txt --ignore Z --N-col N_eff --out ../TEMP/IPWGWAS.munge --merge-alleles ../INPUT/w_hm3.snplist
../SOFTWARE/ldsc/./munge_sumstats.py --sumstats ../OUTPUT/WGWAS/LassoWeight.txt --ignore Z --N-col N_eff --out ../TEMP/IPWWGWAS.munge --merge-alleles ../INPUT/w_hm3.snplist
