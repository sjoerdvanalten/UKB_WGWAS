...
Data<-read.table(paste0("../TEMP/TestPheno",caus,".pheno"))
names(Data)<-c("V1","IID","Pheno")

SNPeffects<-read.table(paste0("../TEMP/TestPheno",caus,".effects"), header=TRUE)
PGI<-read.table(paste0("../TEMP/SimulPGI",caus,".profile"),header=TRUE)
...
write.table(Pheno1,paste0("../TEMP/Simul1_",i,j,"_",caus,".pheno"),sep="\t",col.names=TRUE,row.names=FALSE,quote=FALSE)
write.table(Pheno1[,1:2],paste0("../TEMP/SimulSelect1_",i,j,"_",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)

IDList2a<-Data[Data$UKB2a==TRUE,]
Pheno2a<-IDList2a[,1:3] 
names(Pheno2a)<-c("IID","FID","pheno")
Pheno2a<-Pheno2a[c("FID","IID","pheno")]
write.table(Pheno2a,paste0("../TEMP/Simul2a_",i,j,"_",caus,".pheno"),sep="\t",col.names=TRUE,row.names=FALSE,quote=FALSE)
write.table(Pheno2a[,1:2],paste0("../TEMP/SimulSelect2a_",i,j,"_",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
...
write.table(Pheno2b,paste0("../TEMP/Simul2b_",i,j,"_",caus,".pheno"),sep="\t",col.names=TRUE,row.names=FALSE,quote=FALSE)
write.table(Pheno2b[,1:2],paste0("../TEMP/SimulSelect2b_",i,j,"_",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)

}
}
truth<-SNPinfo$Effect
...
biasmat1$truth<-SNPinfo$Effect


write.table(biasmat1,paste0("../TEMP/Simul1Results",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
write.table(biasmat2a,paste0("../TEMP/Simul1Results2a",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
write.table(biasmat2b,paste0("../TEMP/Simul1Results2b",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)


write.table(SEmat1,paste0("../TEMP/Simul1SEs",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
write.table(SEmat2a,paste0("../TEMP/Simul1SEs2a",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
write.table(SEmat2b,paste0("../TEMP/Simul1SEs2b",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
