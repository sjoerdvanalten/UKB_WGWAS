...
Data<-read.table(paste0("../TEMP/TestPhenoBinary25",caus,".pheno"))
names(Data)<-c("V1","IID","Pheno")

SNPeffects<-read.table(paste0("../TEMP/TestPhenoBinary25",caus,".effects"), header=TRUE)
PGI<-read.table(paste0("../TEMP/SimulPGIBinary25",caus,".profile"),header=TRUE)
...
write.table(Pheno1,paste0("../TEMP/Simul1Binary25_",i,j,"_",caus,".pheno"),sep="\t",col.names=TRUE,row.names=FALSE,quote=FALSE)
write.table(Pheno1[,1:2],paste0("../TEMP/SimulSelect1Binary25_",i,j,"_",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
...
write.table(Pheno2a,paste0("../TEMP/Simul2aBinary25_",i,j,"_",caus,".pheno"),sep="\t",col.names=TRUE,row.names=FALSE,quote=FALSE)
write.table(Pheno2a[,1:2],paste0("../TEMP/SimulSelect2aBinary25_",i,j,"_",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
...
write.table(Pheno2b,paste0("../TEMP/Simul2bBinary25_",i,j,"_",caus,".pheno"),sep="\t",col.names=TRUE,row.names=FALSE,quote=FALSE)
write.table(Pheno2b[,1:2],paste0("../TEMP/SimulSelect2bBinary25_",i,j,"_",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
...
write.table(biasmat1,paste0("../TEMP/Simul1ResultsBinary25",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
write.table(biasmat2a,paste0("../TEMP/Simul1Results2aBinary25",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
write.table(biasmat2b,paste0("../TEMP/Simul1Results2bBinary25",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)


write.table(SEmat1,paste0("../TEMP/Simul1SEsBinary25",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
write.table(SEmat2a,paste0("../TEMP/Simul1SEs2aBinary25",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
write.table(SEmat2b,paste0("../TEMP/Simul1SEs2bBinary25",caus,".txt"),sep="\t",col.names=FALSE,row.names=FALSE,quote=FALSE)
